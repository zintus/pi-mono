...
async function runLoop(
	...
	while (true) {
		...
		// Fire before_idle hook, then re-check queues. Messages queued by the hook
		// satisfy an explicit continuation just like messages already in the queues.
		if (config.beforeIdle) {
